    ...
    <section class="item">
      <div class="item__pics pics">
        <div class="pics__wrapper">
          <img width="570" height="570" style="height: 570px" :src="product.image.file.url" :alt="product.title">
        </div>
      </div>
          ...
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <div class="item__row">
              <div class="form__counter">
                <button type="button" aria-label="Убрать один товар" style="cursor: pointer" @click.prevent="amountMinus()">
                ...
                <button type="button" aria-label="Добавить один товар" style="cursor: pointer" @click.prevent="productAmount += 1">
                  <svg width="12" height="12" fill="currentColor">
    ...
    methods: {
      ...
      amountMinus(){
        if (this.productAmount > 1) {
          this.$emit('productAmount', this.productAmount -= 1);
        }
      },
      addToCart(){
